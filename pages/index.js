    ...
    <>
        ...
        <div className="flex flex-col h-screen my-auto items-center bg-cover justify-center align-items-cente text-white">
            ...
            <div className="block mt-4">
                <a href="https://discord.com/profile/298014369533657090" className="duration-75 p-2 hover:bg-opacity-25 font-lg mr-3 pl-12 pr-12 rounded bg-white bg-opacity-10 border-white border-2">Discord</a>
